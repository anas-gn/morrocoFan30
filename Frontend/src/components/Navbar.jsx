    ...
    <nav className="fixed top-0 w-full z-50 glass transition-all duration-300">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <a href="/attractions" className="group px-4 py-2 hover:bg-green-50 rounded-lg transition-all">
            <div className="flex flex-col items-center gap-1">
          ...
          <a href="/prediction" className="group px-4 py-2 hover:bg-purple-50 rounded-lg transition-all">
            <div className="flex flex-col items-center gap-1">
        ...
        <div className="flex items-center gap-3">
          <a href="/tickets" className="relative overflow-hidden bg-gradient-to-r from-[#C1272D] to-[#a01e23] text-white px-5 py-2.5 rounded-lg font-bold tracking-wide hover:shadow-xl hover:shadow-red-500/40 transition-all flex items-center gap-2 group">
